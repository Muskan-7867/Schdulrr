      ...
      <div className="flex flex-col h-screen bg-blue-50 md:flex-row">
        ...
        <main className="flex-1 overflow-y-auto p-4 md:p-8">
          <header className="flex justify-between items-center mb-4">
            {/* Corrected the typo and added optional chaining for safety */}
            <h2 className="text-5xl text-blue-600 font-bold  md:text-6xl gradient-title pt-2 md:pt-0 text-center md:text-left w-full">
